...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a={feedBackForm:document.querySelector(".feedback-form"),emailInput:document.querySelector("input[name=email]"),msgArea:document.querySelector("textarea[name=message]"),submitBtn:document.querySelector("button[type=submit]")},m={email:"",msg:""};function u(){if(localStorage.getItem("feedback")){const e=JSON.parse(localStorage.getItem("feedback"));a.emailInput.value=e.email,a.msgArea.value=e.msg}}function l(){m.email=a.emailInput.value,m.msg=a.msgArea.value,localStorage.setItem("feedback",JSON.stringify({email:`${m.email}`,msg:`${m.msg}`}))}function n(e){e.preventDefault(),console.table(m),a.emailInput.value="",a.msgArea.value="",l()}a.feedBackForm.addEventListener("input",(0,e.default)(l,500)),a.feedBackForm.addEventListener("submit",n),u();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.ca5a598b.js.map